...
var Markdown = {render: function(){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{domProps:{"innerHTML":_vm._s(_vm.compiled)}})},staticRenderFns: [],
	name: 'Markdown',
	props: {
		text: String
	},
	computed: {
		compiled () {
			...
			return md
			return Prism.highlight('const a = "foo"', Prism.languages.javascript)
		}
	},
	mounted () {
		marked.setOptions({
...
var ExplainMe = {render: function(){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"explain-me"},[_c('div',{staticClass:"opener"},[_c('div',{staticClass:"button",on:{"click":_vm.toggle}},[(!_vm.open)?_c('i',{staticClass:"fa fa-info-circle"}):_vm._e(),(_vm.open)?_c('i',{staticClass:"fa fa-times"}):_vm._e()])]),_c('div',{staticClass:"content"},[_c('div',{staticClass:"md"},[_c('markdown',{attrs:{"text":_vm.content}})],1)])])},staticRenderFns: [],
	name: 'ExplainMe'
	,components: {
		Markdown
	}
